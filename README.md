...
Codex defaults to the fast service tier with minimal reasoning effort. Use
`api_key_env` in `models.json`; rerun `setup.sh` after changing local models,
Codex environment overrides, or `AGENTS.append.md`.
